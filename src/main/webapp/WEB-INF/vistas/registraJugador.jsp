	...
	<form id="id_form"> 
		<div class="row" style="margin-top: 5%">
			<div class="form-group col-sm-6">
				...
				<div class="col-sm-8">
					<input class="form-control" type="text" id="id_nombre" name="nombre" placeholder="Ingrese el nombre" maxlength="15">
				</div>
			</div>
			<div class="form-group  col-sm-6">
				<div class="col-sm-4">
		...
		<div class="row" style="margin-top: 0%">
			<div class="form-group col-sm-6">
				...
				<div class="col-sm-8">
					<input class="form-control" type="text" id="id_pais" name="pais" placeholder="Ingrese el pais" maxlength="8">
				</div>
			</div>
			<div class="form-group  col-sm-6">
				<div class="col-sm-4">
				...
				<div class="col-sm-6">
					<input class="form-control" type="text" id="id_juego" name="juego" placeholder="Ingrese el juego" maxlength="10">
		 		</div>
			</div>
					<div class="form-group  col-sm-6">
				<div class="col-sm-4">
        		...
        		nombre:{
                    ...
                    validators:{
                        ...
                        stringLength: {
                            min: 3,
                            max: 15,
                            message: 'El nombre es de 3 a 15 caracteres'
                        },
                    }
                },
                alias:{
                ...
                pais:{
                    ...
                    validators:{
                        ...
                        stringLength: {
                            min: 2,
                            max: 8,
                            message: 'El pais es de 2 a 8 caracteres'
                        }
                    }
                },
            	juego:{
                    ...
                    validators:{
                        ...
                        stringLength: {
                            min: 4,
                            max: 10,
                            message: 'El juego es de 4 a 10 caracteres'
                        },
                    }
                },
                experiencia:{
